// components/RoadFreightSection.jsx
...
export default function RoadFreightSection({
                                               id = "road",
                                               bgImage = "/truck-driving-into-sunset-highway.jpg",
                                               sideImage = "/truck-logistics-operations-dusk.jpg", // FULL picture on the RIGHT
                                           }) {
        ...
        () => [
            <div className="text-center lg:text-left">
                <h2 className="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight drop-shadow-[0_10px_20px_rgba(0,0,0,0.6)]">
                    Road Freight with <span className="text-[#AD1C42]">MAVA</span>
                </h2>
            </div>,
            ...
            <div className="text-center lg:text-left mt-5">
                <p className="text-lg sm:text-2xl font-semibold text-white/95 drop-shadow-[0_8px_16px_rgba(0,0,0,0.55)]">
                    When the road is long — but everything runs{" "}
                    <span className="text-[#AD1C42]">right.</span>
                </p>
            </div>,
            ...
            <div className="group rounded-2xl border border-white/10 bg-black/40 p-6 sm:p-8 transition-all duration-300 hover:-translate-y-1 hover:border-white/25 hover:bg-white/5 hover:shadow-[0_0_50px_rgba(255,255,255,0.08)]">
                <p className="whitespace-pre-line text-base sm:text-xl text-white/85 leading-relaxed text-center lg:text-left">
                    Road freight isn’t just a route.{"\n"}
                    It’s borders, customs, paperwork, delays, weather, loading, unloading, constant communication.{"\n"}
                    And in this game, it’s not the fastest who wins — but the one who{" "}
                    <span className="text-[#AD1C42] font-semibold">thinks faster.</span>
                </p>
            </div>,

            <div className="group rounded-2xl border border-white/10 bg-black/40 p-6 sm:p-8 transition-all duration-300 hover:-translate-y-1 hover:border-white/25 hover:bg-white/5 hover:shadow-[0_0_50px_rgba(255,255,255,0.08)]">
                <p className="whitespace-pre-line text-base sm:text-xl text-white/85 leading-relaxed text-center lg:text-left">
                    With us, you don’t ask, “Where’s the truck?” — you already know.{"\n"}
                    We’re always in touch — no “let me check,” no “I’ll get back to you.”{"\n"}
                    If there’s a risk — <span className="text-[#AD1C42] font-semibold">we flag it.</span>{"\n"}
                    If there’s a delay — <span className="text-[#AD1C42] font-semibold">we act before you even notice.</span>{"\n"}
                    If you need advice — we’re already one step ahead.
                </p>
            </div>,

            <div className="group rounded-2xl border border-white/10 bg-black/40 p-6 sm:p-8 transition-all duration-300 hover:-translate-y-1 hover:border-white/25 hover:bg-white/5 hover:shadow-[0_0_50px_rgba(255,255,255,0.08)]">
                <p className="whitespace-pre-line text-base sm:text-xl text-white/85 leading-relaxed text-center lg:text-left">
                    Our routes cover the CIS, Turkey, Iran, Europe, and China.{"\n"}
                    <span className="text-[#AD1C42] font-semibold">FTL</span>,{" "}
                    <span className="text-[#AD1C42] font-semibold">LTL</span>, special cargo, temperature control —{"\n"}
                    not just services, but <span className="text-[#AD1C42] font-semibold">tools we use every day.</span>
                </p>
            </div>,

            <div className="group rounded-2xl border border-white/10 bg-black/40 p-6 sm:p-8 transition-all duration-300 hover:-translate-y-1 hover:border-white/25 hover:bg-white/5 hover:shadow-[0_0_50px_rgba(255,255,255,0.08)]">
                <p className="whitespace-pre-line text-base sm:text-xl text-white/85 leading-relaxed text-center lg:text-left">
                    We’re flexible — even when the road isn’t.{"\n"}
                    We know the laws. Understand the markets.{"\n"}
                    And work ahead of the problem — so you don’t lose time, money, or peace of mind.
                </p>

                <div className="mt-6 text-center lg:text-left text-base sm:text-xl text-white/90">
                    <div className="font-extrabold">
                        Road freight with <span className="text-[#AD1C42]">MAVA</span> isn’t just transport.
                    </div>
                    <div className="mt-1 font-extrabold">
                        It’s the confidence that everything’s under control —{" "}
                        <span className="text-[#AD1C42]">even while you sleep.</span>
                    </div>
                </div>
            </div>,
        ],
                              ...
                              hover:shadow-[0_0_60px_rgba(255,255,255,0.08)]">
                                ...
                                <div className="absolute bottom-5 left-5 right-5">
                                    <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-black/45 px-4 py-2 text-sm text-white/90">
                                        <span className="text-[#AD1C42]">●</span> Road operations / FTL • LTL • temp cargo
                                    </div>
                                </div>
                            </div>
                        </Reveal>
